  ...
  theme: {
    extend: {
      ...
      colors: {
        ...
        // === ORIGINAL PALETTE WITH #0a9396 TEAL EMPHASIS ===
        sky_blue: {
          100: '#0d2e3d',
          200: '#1b5c7a',
          300: '#288ab7',
      ...
      boxShadow: {
        ...
        'md': '0 4px 6px -1px rgb(0 0 0 / 0.1), 0 2px 4px -2px rgb(0 0 / 0.1)',
        'lg': '0 10px 15px -3px rgb(0 0 0 / 0.1), 0 4px 6px -4px rgb(0 0 0 / 0.1)',
        'xl': '0 20px 25px -5px rgb(0 0 0 / 0.1), 0 8px 10px -6px rgb(0 0 0 / 0.1)',
        '2xl': '0 25px 50px -12px rgb(0 0 0 / 0.25)',
        '3xl': '0 35px 60px -15px rgb(0 0 / 0.3)',
        'inner': 'inset 0 2px 4px 0 rgb(0 0 0 / 0.05)',
        'inner-md': 'inset 0 4px 8px 0 rgba(0, 0, 0.08)',
        ...
        'premium-sm': '0 2px 4px 0 rgba(0, 0, 0, 0.06), 0 4px 6px -1px rgba(0, 0, 0.08)',
        'premium-md': '0 4px 8px 0 rgba(0, 0, 0.08), 0 6px 12px -2px rgba(0, 0, 0.1)',
        'premium-lg': '0 8px 16px 0 rgba(0, 0, 0, 0.1), 0 12px 24px -4px rgba(0, 0, 0, 0.12)',
        'premium-xl': '0 16px 32px 0 rgba(0, 0, 0.12), 0 24px 48px -8px rgba(0, 0, 0, 0.15)',
        'premium-2xl': '0 24px 48px 0 rgba(0, 0, 0, 0.15), 0 32px 64px -12px rgba(0, 0.18)',
        ...
        'elevated-sm': '0 2px 4px 0 rgba(0, 0.18), 0 4px 6px -1px rgba(0, 0, 0.15)',
        'elevated-md': '0 4px 8px 0 rgba(0, 0.2), 0 6px 12px -2px rgba(0, 0, 0, 0.18)',
